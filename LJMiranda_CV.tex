...
\resumeItem{First-author on a synthetic preference project (ACL); core contributor on T\"ulu 3 (COLM); contributed synthetic data for preference-tuning in OLMo 2 (COLM) and tool-use SFT in OLMo 3.}
