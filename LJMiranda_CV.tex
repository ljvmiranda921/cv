...
{
    \begin{itemize}
        \item Leading the company's open-source initiatives through
        ...
        \item Leading the development of an internal, cloud-based, machine learning
        ...
        \item Developed a computer vision-based household detection model for
            one of the largest telecommunications company in the Philippines to
            aid their capex investments.
        \item Developed an industry classifier for a major investment firm in
            Singapore to augment their financial analysts' investment decisions.
        \item Developed a machine learning model to generate an alternative
            risk index for a major investment firm in Singapore.
    \end{itemize}
}
