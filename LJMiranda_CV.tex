...
{Philippines}{Machine Learning Team}
{
    ...
    \begin{itemize}
        \item Developed several machine learning applications for a major
            investment firm in Singapore. This includes a BERT-based semantic search
            engine, an OCR tool for PDFs, and an industry
    ...
    \begin{itemize}
        \item As Team Lead, managed
            research and engineering efforts in the document processing
            space for the 
            {\color{blue}\httplink[DocumentAI]{https://thinkingmachin.es/our-solutions/\#documentIntelligence}}
