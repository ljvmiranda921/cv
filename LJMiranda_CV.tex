...
% Auto-assign prefixes from 'category' field
\DeclareSourcemap{
  \maps[datatype=bibtex]{
    \map{
      \step[fieldsource=category, final]
      \step[fieldset=labelprefix, origfieldval]
    }
  }
}
...
\resumeItemListStart
\resumeItem{Conducts research in language model post-training, with several peer-reviewed publications \cite{lambert2024tulu,miranda2025hybrid,lambert-etal-2025-rewardbench}.}
...
\resumeItemListStart
\resumeItem{Developed a parallelized Advantage Actor Critic (A2C) algorithm for ChainerRL.}
...
\resumeItemListStart
\resumeItem{Thesis: Autoencoder-based Feature Extraction Techniques for Protein Function Prediction \cite{miranda2018feature,miranda2018deep}}
...
\resumeItem{Published in several NLP conferences \cite{miranda2023calamancy,miranda2023developing}}
\resumeItemListEnd
\resumeProjectHeading
