...
\resumeItemListStart
\resumeItem{Developed NLP products for clients in the financial and utilities sector. Handled several of our biggest clients in Southeast Asia (telco, banking, nonprofit) and also led teams in the Document AI (e.g., document processing, OCR) space.}
