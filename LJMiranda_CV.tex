...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{FilBench: Can LLMs Understand and Generate Filipino?}}{EMNLP '25 Main}
\resumeItem{Lester James V. Miranda*, Elyanah Aco*, Conner Manuel*, Jan Christian Blaise Cruz, Joseph Marvin Imperial}
\resumeProjectHeading
{\textbf{Hybrid Preferences: Learning to Route Instances for Human vs. AI Feedback}}{ACL `25 Main}
\resumeItem{Lester James V. Miranda*, Elyanah Aco*, Conner Manuel*, Jan Christian Blaise Cruz, Joseph Marvin Imperial}
\resumeProjectHeading
{\textbf{Geospatial Data at Scale with Geomancer} (host: Erika Legara) $|$ \emph{Databeers Manila}}{2019}
\resumeItem{Lester James V. Miranda*, Elyanah Aco*, Conner Manuel*, Jan Christian Blaise Cruz, Joseph Marvin Imperial}
