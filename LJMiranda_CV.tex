...
\usepackage[backend=biber,style=numeric,defernumbers=true,minbibnames=7,maxbibnames=99]{biblatex}
...
\resumeItemListStart
\resumeItem{Conducts research in language model post-training, with several peer-reviewed publications \cite{lambert2024tulu,lambert-etal-2025-rewardbench,miranda2025hybrid}.}
