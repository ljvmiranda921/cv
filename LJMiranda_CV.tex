...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{Co-organizer}, 6th Multilingual Representation Learning (MRL) Workshop \& Shared Task $|$ \emph{EMNLP `26}}{2026}
\resumeProjectHeading
{\textbf{Election Committee Member}, 2026--2029 term $|$ \emph{SIGSEA}}{2026}
\resumeProjectHeading
{\textbf{Reviewer (Conferences)}: ICLR, COLM, ARR (ACL, EMNLP)}{}
\resumeProjectHeading
{\textbf{Reviewer (Journals)}: Philipp. J. Sci. (PJS), Philipp. Comput. J. (PCJ), J. Open Source Softw. (JOSS)}{}
\resumeSubHeadingListEnd
