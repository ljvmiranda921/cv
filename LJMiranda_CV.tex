...
\resumeItemListStart
\resumeItem{Conducted research in language model post-training and alignment \cite{lambert-etal-2025-rewardbench,miranda2025hybrid,lambert2024tulu,olmo20242}.}
...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{UKRI PhD Studentship for Multilingual NLP (EQUATE)} $|$ \emph{University of Cambridge}}{2025}
\resumeProjectHeading
...
{\textbf{Reviewer}}{}
\resumeItemListStart
\resumeItem{Conferences: ICLR (2025), COLM (2025), ARR (May 2025).}
\resumeItem{Journals: Philippine Computing Journal (PCJ) vol. 18, Journal of Open-Source Software (JOSS)}
\resumeItem{Outstanding / Great Reviewer: May ARR 2025 }
\resumeItemListEnd
