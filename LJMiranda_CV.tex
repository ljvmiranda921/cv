...
\resumeItemListStart
\resumeItem{Conducts research broadly in LLM post-training and alignment, such as preference annotation (\textsc{MultiPref}), reward model evaluation (\textsc{RewardBench}), and fully open-source post-training recipes (\textsc{T\"ulu 3}).}
