...
{Machine Learning Researcher / Consultant}{Metro Manila, PH}
\resumeItemListStart
\resumeItem{Built NLP products for major Southeast Asian clients across the telco, banking, and nonprofit sectors.}
...
\resumeItemListStart
\resumeItem{Project: Parallel Advantage Actor Critic (A2C) algorithm for ChainerRL}
...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{NLP Lecture for AI Olympiad} (host: Martin Gomez) $|$ \emph{Internat. Olympiad for AI - Team PH}}{2026}
\resumeProjectHeading
...
\resumeSubHeadingListStart
\resumeProjectHeading
{\textbf{Conference Reviewer}: ICLR, COLM, ARR (ACL, EMNLP)}{}
\resumeProjectHeading
{\textbf{Journal Reviewer}: Philipp. J. Sci. (PJS), Philipp. Comput. J. (PCJ), J. Open Source Softw. (JOSS)}{}
\resumeProjectHeading
{\textbf{Scientific Committee \& Trainer}, Philippine Team - International Olympiad for AI $|$ \emph{IOAI PH}}{2026}
\resumeProjectHeading
